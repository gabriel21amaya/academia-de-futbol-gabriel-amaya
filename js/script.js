$(document).ready(function(){
	...
	// filosofia1 - Welcome
	var filosofia1 = $("#filosofia-medida");
	filosofia1.owlCarousel({
		singleItem : true,
		autoPlay : 5000,
		pagination : true
	});
	...
	// filosofia2 - Welcome
	var filosofia2 = $("#filosofia-medida-2");
	filosofia2.owlCarousel({
		singleItem : true,
		autoPlay : 5000,
		pagination : true
	});
	...
	function historyInit(){
		...
		$.each(this.owl.userItems, function (i) {
			$(pafinatorsLink[i]).text( $(this).find('.title').attr('metodologia-numero') );
		});
	}
